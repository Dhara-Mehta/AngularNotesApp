...
export const NOTES : Note[] = [
  ...
  {Id: 10, Title: "Shopping List", Content: null, 
      ToDoItems: [{ TodoId: 1, TaskName: "Milk", Complete: false, MouseOver: false, Note_Id: 10},
      { TodoId: 2, TaskName: "Bread", Complete: false, MouseOver: false, Note_Id: 10},
      { TodoId: 3, TaskName: "Bananas", Complete: true, MouseOver: false, Note_Id: 10},
      { TodoId: 4, TaskName: "Fruits", Complete: false, MouseOver: false, Note_Id: 10},
      { TodoId: 5, TaskName: "Veggies", Complete: false, MouseOver: false, Note_Id: 10},
      { TodoId: 6, TaskName: "Yogurt", Complete: false, MouseOver: false, Note_Id: 10}
